...
// Company_Admin 클래스는 Company 인터페이스를 구현하며, 관리자의 기능을 담당합니다.
public class Company_Admin implements Company {
    ...
    // 현재 로그인된 관리자의 정보를 담을 CompanyDTO 객체 선언
    CompanyDTO companyDTO = null;
    
    // 생성자: CompanyDTO 객체를 받아 초기화
    public Company_Admin(CompanyDTO companyDTO) {
